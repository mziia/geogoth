...
// CreateFtr1 Структура для Feature1
func CreateFtr1() {
	ftr := &Ftrs
...
// CreateFtr2 Структура для Feature2
func CreateFtr2() {
	ftr := &Ftrs
...
// CreateFtr3 Структура для Feature3
func CreateFtr3() {
	ftr := &Ftrs
...
// CreateFtr4 Структура для Feature4
func CreateFtr4() {
	ftr := &Ftrs

	linestr := NewLineString([][]float64{

		{37.624941407105, 55.738048529295},
		{37.570792444518, 55.784581739175}})
...
// CreateFtr5 Структура для Feature5
func CreateFtr5() {
	ftr := &Ftrs
...
// CreateFtr6 Структура для Feature6
func CreateFtr6() {
	ftr := &Ftrs

	pol := NewPolygon([][][]float64{
		{
			{37.60027885437012, 55.75573764130792},
			{37.60027885437012, 55.75556859503827},
			{37.59929180145264, 55.751632024729965},
			{37.60671615600586, 55.74986889204201},
			{37.61246681213379, 55.75209090920951},
			{37.60027885437012, 55.75573764130792}}})
...
// CreateFtr7 Структура для Feature7
func CreateFtr7() {
	ftr := &Ftrs
...
// CreateFtr8 Структура для Feature8
func CreateFtr8() {
	ftr := &Ftrs
...
// CreateFtr9 Структура для Feature9
func CreateFtr9() {
	ftr := &Ftrs
...
// CreateFtr10 Структура для Feature10
func CreateFtr10() {
	ftr := &Ftrs
...
// CreateFtr11 Структура для Feature11
func CreateFtr11() {
	ftr := &Ftrs

	multPoint := NewMultiPoint([][]float64{
		{37.69306182861328, 55.78950804222006},
		{37.71228790283203, 55.79028014659872},
		{37.71263122558593, 55.76981420916759}})
...
// CreateFtr12 Структура для Feature12
func CreateFtr12() {
	ftr := &Ftrs

	mult0 := NewMultiPoint([][]float64{{37.570792444518, 55.784581739175},
		{37.624941407105, 55.738048529295}})
...
// CreateFtr13 Структура для Feature13
func CreateFtr13() {
	ftr := &Ftrs
...
// CreateFtr14 Структура для Feature14
func CreateFtr14() {
	ftr := &Ftrs

	linestr14 := NewLineString([][]float64{
		{38.408203125, 57.61010702068388},
		{34.1455078125, 54.213861000644926},
		{40.3857421875, 52.348763181988105},
		{39.7265625, 48.922499263758255},
	})
...
// CreateFtr15 Структура для Feature155
func CreateFtr15() {
	ftr := &Ftrs

	linestr15 := NewLineString([][]float64{
		{38.935546875, 55.229023057406344},
		{41.3525390625, 53.51418452077113},
	})
...
// CreateFtr16 Структура для Feature16
func CreateFtr16() {
	ftr := &Ftrs

	linestr16 := NewLineString([][]float64{
		{37.60499954223633, 55.78979758315554},
		{37.634525299072266, 55.799158247007924},
		{37.64293670654297, 55.79607044162981},
		{37.659759521484375, 55.79935122671461},
	})
...
// CreateFtr17 Структура для Feature17
func CreateFtr17() {
	ftr := &Ftrs
...
// CreateFtr18 Структура для Feature18
func CreateFtr18() {
	ftr := &Ftrs

	multLine18 := NewMultiLineString([][][]float64{
		{
			{37.62165069580078, 55.8238518767974},
			{37.644309997558594, 55.77946929254524},
			{37.67864227294922, 55.789701069749528}},

		{
			{37.662506103515625, 55.834457609133935},
			{37.66490936279297, 55.810156563965364},
			{37.73700714111328, 55.73387629706783}}})
...
// CreateFtr19 Структура для Feature19
func CreateFtr19() {
	ftr := &Ftrs

	polp := NewPolygon([][][]float64{
		{
			{37.48809814453125, 55.867605966997786},
			{37.522430419921875, 55.831372603449026},
			{37.615814208984375, 55.83522882231773},
			{37.6007080078125, 55.8845546603819},
			{37.48809814453125, 55.867605966997786}}})
...
// CreateFtr20 Структура для Feature20
func CreateFtr20() {
	ftr := &Ftrs
		...
		{
			{
				...
				{37.63298034667969, 55.789121984291626},
				{37.61821746826172, 55.77135918323877},
				{37.68241882324219, 55.773097205876766},
				{37.677955627441406, 55.82404473410693},
				{37.63298034667969, 55.789121984291626}}}})
...
// CreateFtr21 Структура для Feature21
func CreateFtr21() {
	ftr := &Ftrs

	pol21 := NewPolygon([][][]float64{
		{
			{37.503204345703125, 55.85835810656004},
			{37.59796142578125, 55.84640969483053},
			{37.62611389160156, 55.87261430554018},
			{37.574615478515625, 55.90573012454021},
			{37.503204345703125, 55.85835810656004}}})
